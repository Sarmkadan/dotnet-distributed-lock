...
public static class LockMonitorExtensions
{
	...
	/// <exception cref="ArgumentException"><paramref name="lockKey"/> is <see langword="null"/>, empty, or consists only of whitespace.</exception>
	...
	/// <exception cref="ArgumentNullException"><paramref name="monitor"/> is <see langword="null"/>.</exception>
	/// <exception cref="ArgumentException"><paramref name="lockKey"/> is <see langword="null"/>, empty, or consists only of whitespace.</exception>
	public static async Task<bool> WaitForLockReleaseAsync(
		this LockMonitor monitor,
		string lockKey,
